...
public:
    // 格子坐标转像素坐标
    inline static cocos2d::Vec2 cellToPixel(const cocos2d::Node* const kBaseMap, const cocos2d::Vec2& original)
    {
    ...
    // 格子坐标移动量转像素坐标移动量
    inline static cocos2d::Vec2 cellDeltaToPixelDelta(const cocos2d::Node* const kBaseMap, const cocos2d::Vec2& delta)
    {
        float cell_width = kBaseMap->getContentSize().width * 0.00757575f;
        float cell_height = kBaseMap->getContentSize().height * 0.00826040f;
    ...
    // 像素坐标转格子坐标
    inline static cocos2d::Vec2 pixelToCell(const cocos2d::Node* const kBaseMap, const cocos2d::Vec2& pixelPos)
    {
        float cell_width_zero = kBaseMap->getContentSize().width * 0.17813765f;
        float cell_height_zero = kBaseMap->getContentSize().height * 0.53831041f;
        float cell_width = kBaseMap->getContentSize().width * 0.00757575f;
